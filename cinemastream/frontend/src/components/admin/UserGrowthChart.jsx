    ...
    <div className="chart">
      ...
      <ResponsiveContainer width="100%" height={300}>
        <LineChart data={data} margin={{ top: 20, right: 30, left: 20, bottom: 20 }}>
          ...
          <XAxis dataKey="month" stroke="#ccc" label={{ value: 'Month', position: 'insideBottom', dy: 10, fill: '#ccc' }} />
          <YAxis stroke="#ccc" label={{ value: 'Registered Users', angle: -90, position: 'insideLeft', dx: -10, fill: '#ccc' }} />
