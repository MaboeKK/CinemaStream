...
function Series() {
  ...
  const trackWatchEvent = async (seriesId) => {
    try {
      ...
      await axios.post("http://localhost:5000/api/watch", payload);
    } catch (err) {
      console.error("Failed to track watch event", err);
    }
  };
